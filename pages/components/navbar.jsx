            ...
            <div name ='navbar'className="bg-gray-900 py-3 flex justify-between" >
                ...
                <div name='foto usuario' className="w-80 mx-10 flex justify-evenly">
                    <button onClick={()=>router.push('/user')}
                            className='bg-blue-500 my-4 mx-2 px-1 rounded-xl hover:bg-blue-700 hover:text-white'>Editar Perfil</button>
                    <button onClick={()=>signOut()}
                            className='bg-blue-500 my-4 mx-2 px-1 rounded-xl hover:bg-red-600 hover:text-white'>Cerrar sesion</button>
