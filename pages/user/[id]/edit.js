...
export default function Index() {
  ...
  return (
    <div className="bg-gray-10 h-screen">
      ...
      <div
        className={
          "grid my-10 mx-64 p-10 bg-gray-200 rounded-3xl shadow-inherity  "
        }
      >
        <div className={"grid"}>
          <form onSubmit={handleSubmit}>
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Nombre:</h1>
              <input
                value={newUser.nombres}
                name="nombres"
                className={"my-2 rounded-2xl bg-white "}
                onChange={handleChange}
              ></input>
            </label>
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Apellidos:</h1>
              <input
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Imagen:</h1>
              <img
                name="imagen"
                className={"my-2 rounded-2xl"}
                src={newUser.image}
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Telefono:</h1>
              <input
                name="telefono"
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Email:</h1>
              <input
                name="email"
                value={newUser.email}
                className={"my-2 rounded-2xl"}
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Direccion:</h1>
              <input
                name="direccion"
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Fecha:</h1>
              <input
                name="fecha"
                value={newUser.fecha}
                className={"my-2 rounded-2xl"}
            ...
            <label className={"flex justify-center "}>
              <h1 className={"text-xl mr-10"}>Genero:</h1>
              <select
                name="genero"
            ...
            <button
              type="submit"
              className={
                "w-full text-xl text-white px-5 py-2 rounded-2xl bg-blue-800"
              }
            >
              Guardar cambios{" "}
            </button>
